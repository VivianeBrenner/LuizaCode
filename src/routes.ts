...
routes.get('/clientes/:clienteId/carrinho', /* #swagger.tags = ['Carrinho'] */ ShoppingCartsController.getCart)
routes.put('/clientes/:clienteId/carrinho', /* #swagger.tags = ['Carrinho'] */ShoppingCartsController.updateCart)
routes.delete('/clientes/:clienteId/carrinho', /* #swagger.tags = ['Carrinho'] */ShoppingCartsController.clearCart)
routes.put('/clientes/:clienteId/carrinho/checkout', /* #swagger.tags = ['Carrinho'] */ ShoppingCartsController.checkout)
